...
/**
 * Phase 7 — Restaurant Storefront, Template 1 (Minimal)
 * Menu View Page  (/menu)
 *
 ...
 */
@Component({
  selector: 'app-restaurant-minimal-menu-view',
  standalone: true,
  imports: [
    CommonModule,
    RouterLink,
...
export class RestaurantMinimalMenuViewComponent implements OnInit, AfterViewInit, OnDestroy {
