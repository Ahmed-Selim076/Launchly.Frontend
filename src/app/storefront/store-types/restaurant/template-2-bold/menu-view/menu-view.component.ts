...
/**
 * Phase 7 — Restaurant Storefront, Template 1 (Bold)
 * Menu View Page  (/menu)
 *
 ...
 */
@Component({
  selector: 'app-restaurant-bold-menu-view',
  standalone: true,
  imports: [
    CommonModule,
    RouterLink,
...
export class RestaurantBoldMenuViewComponent implements OnInit, AfterViewInit, OnDestroy {
