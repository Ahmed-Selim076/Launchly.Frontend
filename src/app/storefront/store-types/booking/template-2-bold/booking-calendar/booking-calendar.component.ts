...
/**
 * Phase 6 — Booking Storefront, Template 1 (Bold)
 * Booking Calendar Page  (/book/:serviceId)
 *
 * Layout philosophy (Bold — centred, whitespace-forward):
...
@Component({
  selector: 'app-booking-bold-calendar',
  standalone: true,
  imports: [
...
export class BookingBoldCalendarComponent implements OnInit {
