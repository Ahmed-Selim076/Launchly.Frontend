...
/**
 * Phase 6 — Booking Storefront, Template 1 (Minimal)
 * Booking Calendar Page  (/book/:serviceId)
 *
 * Layout philosophy (Minimal — centred, whitespace-forward):
...
@Component({
  selector: 'app-booking-minimal-calendar',
  standalone: true,
  imports: [
...
export class BookingMinimalCalendarComponent implements OnInit {
